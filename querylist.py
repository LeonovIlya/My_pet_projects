...
get_query_with_access = "SELECT name, access_level FROM users"
set_tg_id = "UPDATE users SET tg_id = ? WHERE password = ?"
insert_user = "INSERT INTO users (name, password, access_level, supervisor_name) VALUES (?, ?, ?, ?)"
...
edit_user_access_level = "UPDATE users SET access_level = ? WHERE name = ?"
edit_user_supervisor = "UPDATE users SET supervisor_name = ? WHERE name = ?"
